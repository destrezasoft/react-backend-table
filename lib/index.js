...
let BackendTable = ({ columns, options }) => {
    ...
    const makePagination = () => {
        ...
        items.push(_jsx(Pagination.First, {
            disabled: previousFirstDisable, onClick: () => {
                setPaginationData(Object.assign(Object.assign({}, paginationData), { currentPage: 1, paginationStartWith: 1 }));
            }
        }, 'first'));
        items.push(_jsx(Pagination.Prev, {
            disabled: previousFirstDisable, onClick: () => {
        ...
        for (let number = paginationData.paginationStartWith; pagePrint >= 1; number++) {
            ...
            if (number === paginationData.currentPage) {
                ...
                items.push(_jsx(Pagination.Item, Object.assign({
                    onClick: () => {
        ...
        pagePrint = 4;
        items.push(_jsx(Pagination.Next, {
            disabled: nextlastDisable, onClick: () => {
                if (paginationData.currentPage < totalPage)
                    setPaginationData(Object.assign(Object.assign({}, paginationData), { currentPage: paginationData.currentPage + 1, paginationStartWith: paginationData.paginationStartWith + 1 }));
            }
        }, 'next'));
        items.push(_jsx(Pagination.Last, {
            disabled: nextlastDisable, onClick: () => {
        ...
        return columns.map((column, index) => {
            if (column.sortable === true) {
                return (_jsxs("th", Object.assign({
                    className: column.thClass, style: column.thStyle, onClick: () => {
                    ...
                    children: [column.title, column.field === postData.orderBy &&
                        postData.orderType === "asc" ? (_jsx(BiSortDown, { className: "float-right", size: 20 }, index + 'asc')) : null, column.field === postData.orderBy &&
                            postData.orderType === "desc" ? (_jsx(BiSortUp, { className: "float-right", size: 20 }, index + 'desc')) : null]
                }), index));
            }
            else {
            ...
            if (column.searchable) {
                return (_jsx("th", {
                    children: _jsx(Form.Control, {
                        className: "float-center", type: "text", placeholder: "Search ... ", size: "sm", name: column.field, onChange: (e) => {
    ...
    return (_jsx(Card, {
        children: _jsxs(Card.Body, {
            children: [_jsx(Row, { children: _jsx(Col, Object.assign({ md: "4" }, { children: _jsx(Card.Title, { children: options.title }) })) }), _jsxs(Row, {
                children: [_jsx(Col, Object.assign({ className: "float-left", md: "1" }, {
                    children: _jsx(Form.Select, Object.assign({
                    ...
                    }, { children: makePerPageSelectBox() }))
                })), _jsxs(Col, Object.assign({ className: "float-left", style: { paddingLeft: "0px", paddingTop: "5px" }, md: "2" }, { children: [" of ", totalData] })), _jsx(Col, Object.assign({ className: "float-left", md: "4" }, {
                    children: _jsx(Pagination, Object.assign({
                        size: "sm", onClick: (e) => {
                            console.log();
                        }
                    }, { children: makePagination() }))
                })), _jsxs(Col, Object.assign({ className: "float-right", md: "5" }, {
                    children: [_jsx(Form.Control, {
                        style: { width: "70%", display: "inline" }, className: "float-center", type: "text", placeholder: "Search ... ", size: "sm", onChange: (e) => {
                            setGlobalSearch(e.target.value);
                        }
                    }), _jsx(Button, Object.assign({
                        variant: "outline", className: "btn btn-success btn-lg ", style: { marginLeft: "10px" }, size: "sm", onClick: () => {
                    ...
                    }, { children: "Show" })), _jsx(BiExport, {
                        style: { marginLeft: "5px" }, size: 30, onClick: () => {
