...
let BackendTable = ({ columns, options }) => {
    ...
    return (_jsx(Card, { children: _jsxs(Card.Body, { children: [_jsx(Row, { children: _jsx(Col, Object.assign({ md: "4" }, { children: _jsx(Card.Title, { children: options.title }, void 0) }), void 0) }, void 0), _jsxs(Row, { children: [_jsx(Col, Object.assign({ className: "float-left", md: "1" }, { children: _jsx(Form.Select, Object.assign({ size: "sm", className: "form-control float-left", style: { height: 35 }, value: paginationData.perPageData, onChange: (e) => {
                                ...
                                } }, { children: makePerPageSelectBox() }), void 0) }), void 0), _jsxs(Col, Object.assign({ className: "float-left", style: { paddingLeft: "0px", paddingTop: "5px" }, md: "2" }, { children: [" of ", totalData] }), void 0), _jsx(Col, Object.assign({ className: "float-left", md: "4" }, { children: _jsx(Pagination, Object.assign({ size: "sm", onClick: (e) => {
                                    console.log();
                                } }, { children: makePagination() }), void 0) }), void 0), _jsxs(Col, Object.assign({ className: "float-right", md: "5" }, { children: [_jsx(Form.Control, { style: { width: "70%", display: "inline" }, className: "float-center", type: "text", placeholder: "Search ... ", size: "sm", onChange: (e) => {
